...
//     console.log('Маршрут изменился:', { old: oldRouteName, new: newRouteName })
    
//     // Если перешли на любую страницу кроме OpenCase
//     if (newRouteName !== 'OpenCase') {
//         console.log('Выполняем сброс состояния')
//         resetState()
//     }
// }, { immediate: true })
